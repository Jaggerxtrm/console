...
This project is indexed by GitNexus as **console** (6463 symbols, 16009 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
