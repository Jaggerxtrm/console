  ...
  return {
    ...
    surfaces: [
      ...
      },
      {
        ...
        currentOwner: "packages/core",
        targetOwner: "packages/core",
        currentPaths: ["packages/core/src/github", "apps/gitboard/src/core/github-store.ts", "apps/gitboard/src/core/github-poller.ts", "apps/gitboard/src/core/github-discover.ts", "apps/gitboard/src/core/github-readme.ts", "apps/gitboard/src/api/routes/github.ts"],
        targetExport: "@xtrm/core/github",
        knownHighRiskSymbols: ["GithubPoller"],
        preserves: ["durable GitHub tables", "poller skip behavior", "route DTOs", "PR detail cache behavior", "markdown/report path restrictions", "channel publish behavior"],
        deprecationGate: "Core owns durable GitHub adapter state and reusable route runtime helpers; app route/startup code only wires HTTP compatibility.",
      ...
      },
      {
        ...
        kind: "shell",
        state: "core-owned",
        currentOwner: "apps/console",
        targetOwner: "apps/console",
        currentPaths: ["packages/core/src/terminal", "apps/console/src/server/terminal", "apps/console/src/server/routes/shell.ts", "apps/console/src/server/routes/terminal.ts", "apps/console/src/server/ws/boundary.ts", "apps/gitboard/src/api/terminal/provider-registry.ts"],
        targetExport: "apps/console/src/server/terminal with @xtrm/core/terminal contracts/providers",
        ...
        deprecationGate: "Console owns Bun upgrades, bridge, routes, and PTY helper injection; the Gitboard provider adapter remains only for rollback until apps/gitboard deletion.",
        nextBead: "forge-wv9i.7",
