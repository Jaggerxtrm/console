...
export function createSpecialistsConfigRouter(options: SpecialistsConfigRouterOptions = {}): Hono {
  ...
  router.get("/", async (c) => {
    ...
    emit(makeLogEntry("api", "specialists.config", "info", "read specialists config", {
      action: "read",
  ...
  router.patch("/user", async (c) => {
    ...
    emit(makeLogEntry("api", "specialists.config", "info", "updated specialists user config", {
      action: "user.write",
  ...
  router.patch("/console", async (c) => {
    ...
    emit(makeLogEntry("api", "specialists.config", "info", "updated console repo registry", {
